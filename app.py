...
# --- 5. DOI/ISBN ---
    ...
    st.write("Taxa única ISBN, para o documento que conterá todos os resumos dos Anais (R$ 35,00). Caso tenha registrado ISBN do seu evento, informe o número para ser anexado ao documento")
    st.info("ℹ️ **Chave PIX:** eventos@sciencenexus.com.br")
